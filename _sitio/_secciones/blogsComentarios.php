...
$avatares=array();
$selas="SELECT * FROM blogsCom WHERE  idPost='$exp' and idComentario=''  and muerto='0'  order by cuando DESC";
...
<div class="botonEnviar right" onClick="comentaB('<?=$exp?>','<?=$com?>');">Responder</div>
</div>
</div>

<div class="div100" id="com<?=$com?>"><? include "blogsComentariosReply.php"; ?></div>
