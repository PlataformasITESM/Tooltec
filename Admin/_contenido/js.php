		...
		var orden="";	
			...
			orden=$('#'+este).sortable('toArray').toString();
		 	...
		 	$.ajax({
				...
				type: "POST",
				url: "<?=$url?>/_contenido/contenido/reordenElementos.php",
...
function elementoTipo(donde,padre,elemento){
	...
	$.ajax({
    type: "POST",
    url: "<?=$url?>/_contenido/contenido/"+donde+".php",
		  ...
		  $('#orden').val(orden);
			...
			var tab=$('#tab').val();
		 	$.ajax({
				...
				type: "POST",
				url: "<?=$url?>/_contenido/contenido/reorden.php",
...
function eliminarE(mata){
	...
	$.ajax({
    type: "POST",
    url: "<?=$url?>/_contenido/contenido/mata.php",
