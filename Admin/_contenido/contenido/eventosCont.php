...
<div class="oculta tabsDivs" id="ele-fondo">
	 ...
	 <div class="formaB ">
	<div class="formaT ">Campus</div>
    <div class="formaC">
	<label><input <? if($campus['guadalajara']!="") { ?>checked <? } ?> name="campus[]" class=" " value="guadalajara" type="checkbox">Guadalajara</label>
	<div class="clear"></div>
	<label><input <? if($campus['tabasco']!="") { ?>checked <? } ?> name="campus[]" class=" " value="tabasco" type="checkbox">Tabasco</label>
	<div class="clear"></div>
	</div>
	</div>
...
$selas="select * from niveles where muerto='0' and tabs!='4' order by orden asc   ";
