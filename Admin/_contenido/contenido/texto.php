...
$transparente=1;
 ...
 while ($fila = $res6->fetch_assoc()) 
	...
	$transparente=$parametros['transparente'];
...
$elArchivo=$arregloArchivos[$imgFondo.'imagen'];
  ...
  <div class="div100   blanco10">  
    ...
    <form action="texto.php" method="post" enctype="multipart/form-data" id="forma">
...
<div class="formaB">
    ...
    <div class="formaC">
	<div class="left">
	<input type="color" id="colorFondo" name="colorFondo"  onChange="$('#transparente').prop( 'checked', false );"  value="<?=$colorFondo?>" >
   
	</div>
	
	<label class="left">
	<input type="checkbox" id="transparente" value="1" <? if($transparente==1) { ?>checked <? } ?> name="transparente"> Transparente
	</label>
	</div>
...
if ($formA=="afecta")
{
	...
	$parametros['transparente']=$transparente;
