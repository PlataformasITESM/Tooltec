...
$tituloT="Nuevo landing";

$res6 = $mysqli->query("SELECT * FROM landings WHERE id='$valor' AND muerto='0' ");
 $res6->data_seek(0);
...
<span style="font-size:14px;" id="estamosTSub">landings</span>
...
<a href="<?=$url?>/_secciones/landings/">     
