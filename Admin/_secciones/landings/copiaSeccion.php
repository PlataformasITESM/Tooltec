...
include "../../sesion/mata.php"; 
 ...
 $res6 = $mysqli->query("SELECT * FROM landings WHERE id='$copia'");
 $res6->data_seek(0);
...
$cambia=aleatorio(10);
//$cambia="homeTabasco";	
	$query="INSERT INTO landings (id, tipo, titulo_es, tituloC_es, titulo_en, tituloC_en, tituloPagina_es, tituloPagina_en, url_es, url_en, meta, creado ) VALUES ('$cambia', '$tipo', '$titulo_es','$tituloC_es','$titulo_en','$tituloC_en', '$tituloPagina_es', '$tituloPagina_en',  '$url_es',  '$url_en',  '$meta', '$creado' )";
 	$mysqli->query($query);
...
?>
<script>top.location.href = "<?=$url?>/_secciones/landings/landingsAdd?u=<?=$cambia?>";</script>