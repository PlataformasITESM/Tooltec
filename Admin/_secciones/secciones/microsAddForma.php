...
<div class="blanco10">
<form action="microsAddForma.php" method="post" enctype="multipart/form-data" id="forma">
...
<div class="formaB seo">
    ...
    <div class="formaC">
   	<input id="tituloPagina_en"  name="tituloPagina_en"  type="text" class="  field"  value="<?=$tituloPagina_en?>" />
	</div>
</div>
...
<div class="formaB url">
	...
	<div style="position: absolute; padding: 6px;" id="urlas"> /es/<?=$urlM_es?>/&nbsp;</div>
...
<div class="formaB url">
    ...
    <div class="formaC" style="position: relative;">
		<div style="position: absolute; padding: 6px;"  > /en/<?=$urlM_en?>/&nbsp; </div>
...
if($cambia!=""){
	...
	$query="UPDATE microSitios SET tipo='$tipo', permisos='$permisos',  titulo_es='$titulo_es', tituloC_es='$tituloC_es', titulo_en='$titulo_en', tituloC_en='$tituloC_en', tituloPagina_es='$tituloPagina_es', tituloPagina_en='$tituloPagina_en', url_es='$url_es', url_en='$url_en', meta='$meta', modificado='$creado', menuSuperior='$menuSuperior', menuLateral='$menuLateral', activo='$activo'  WHERE id='$cambia'";
	$mysqli->query($query);
...
$cambia=aleatorio(10);
	...
	$query="INSERT INTO microSitios (id, idMenu, tipo, permisos, titulo_es, tituloC_es, titulo_en, tituloC_en, tituloPagina_es, tituloPagina_en, url_es, url_en, meta, menuSuperior, menuLateral, activo, creado ) VALUES ('$cambia', '$m', '$tipo', '$permisos', '$titulo_es','$tituloC_es','$titulo_en','$tituloC_en', '$tituloPagina_es', '$tituloPagina_en',  '$url_es',  '$url_en',  '$meta', '$menuSuperior','$menuLateral', '$activo', '$creado' )";
 	$mysqli->query($query);
...
?>
<script>top.location.href = "<?=$url?>/_secciones/secciones/micro?u=<?=$m?>";</script>	
<?
 } ?>