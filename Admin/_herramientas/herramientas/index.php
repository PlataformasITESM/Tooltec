...
if($tipoU=="admin" || $puedoEditor==1) { ?>
 <a href="herramientasAdd" >
         <div class="botonSin left" id="c_agregar"  >
      <div class="material-icons ">add</div>
       		<div class=" div100 " >Agregar herramienta</div>
</div>  
</a>

<div onClick="reordena('herramientas');" class="botonSin right" id="c_agregar"  >
