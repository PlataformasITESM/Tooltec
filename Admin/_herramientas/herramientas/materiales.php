...
<? include "tabs.php"; ?>
 ...
 <a href="materialesAdd?u=<?=$valor?>" >
         <div class="botonSin left" id="c_agregar"  >
      <div class="material-icons ">add</div>
       		<div class=" div100 " >Agregar material</div>
</div>  
</a>

<div onClick="reordena('herramientasPasos');" class="botonSin right" id="c_agregar"  >
      <div class="material-icons">swap_vert</div>
       		<div class=" div100 " >Reordenar</div>
</div> 

<div class="blanco10">  
<? include "materialesTodos.php" ;?>
</div>
</div>
...
$('#q_herramientas').addClass('seccionMenuP');
	$('#c_materiales').addClass('seccionMenuP');
</script>
