...
$res6 = $mysqli->query("SELECT * FROM herramientasCom WHERE idHerramienta='$valor' and idComentario='' and muerto='0' ORDER BY idComentario ASC, cuando desc");
$res6->data_seek(0);
...
$res6d = $mysqli->query("SELECT * FROM herramientasCom WHERE idHerramienta='$valor' and idComentario='$idU' and muerto='0' ORDER BY idComentario ASC, cuando desc");
$res6d->data_seek(0);
