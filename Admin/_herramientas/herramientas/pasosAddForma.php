...
<form action="pasosAddForma.php" method="post" enctype="multipart/form-data" id="forma">
...
<? } ?>
 ...
 <div class="formaB">
   ...
   <option value="texto">Paso</option>
...
$va=$va+1;
	...
	$cambia=aleatorio(10);
	$query="INSERT INTO herramientasPasos (id, idHerramienta, tipoPaso, tipo, texto_es, orden) VALUES ('$cambia', '$herramienta', 'paso', '$tipo', '$texto_es', '$va')";
	$mysqli->query($query);
...
top.location.href = "pasos?u=<?=$herramienta?>";</script>	
</script>	
<?
 } ?>