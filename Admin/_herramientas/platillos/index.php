...
if($tipoU=="admin" || $puedoEditor==1) { ?>
 <a href="platillosAdd" >
      ...
      <div class="material-icons ">add</div>
       		<div class=" div100 " >Agregar platillo</div>
</div>  
</a>

<div onClick="reordena('recetasPlatillos');" class="botonSin right" id="c_agregar"  >
...
<div style="clear:both;"></div>
    ...
    <script>
$('#q_platillos').addClass('seccionMenuP');
</script>
