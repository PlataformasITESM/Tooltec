...
$res6 = $mysqli->query("SELECT * FROM quesosPlatillos where muerto='0' ORDER BY orden ASC ");
$res6->data_seek(0);
...
<tr data-titulo="<?=$titulo?>" class="linea" id="<?=$idU?>" style="opacity: <?=$opa?>" >
 <td><?=$orden?></td>
<td  ><a href="platillosAdd.php?u=<?=$idU?>"> 
<div class="div100">
<div class="div100" style="padding-left: 70px"><?=$titulo?></div>
<div class="absoluteV" style="left: 0">
<img src="/productos/usos/<?=$idU?>/t_<?=$img?>"  style="max-height: 40px; max-width: 60px">
</div>
</div>
</a></td>
<td><?=ucfirst($linea)?></td>
...
<a class="left padd10 opacidad6" href="platillosAdd?u=<?=$idU?>">
 Editar
</a>
 </td>
</tr>
