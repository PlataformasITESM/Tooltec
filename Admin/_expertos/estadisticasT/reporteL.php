...
while ($fila = $res6->fetch_assoc()) 
{
	...
	$arregloRegistros[$esteCuando]['totalLikes']=$arregloRegistros[$esteCuando]['totalLikes']+1;
	
	
	$arregloRegistros[$esteCuando][$idExperto]['likes']=$arregloRegistros[$esteCuando][$idExperto]['likes']+1;
...
//grafi
	...
	foreach ( $period as $dt ) {
	  ...
	  if($registros==""){$registros=0;}
		...
		$visitas=$arregloRegistros[$esteDia]['totalLikes']; if($visitas<1){$visitas=0;}
