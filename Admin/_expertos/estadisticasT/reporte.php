...
while ($fila = $res6->fetch_assoc()) 
{
	...
	$arregloRegistros[$esteCuando]['totalVistas']=$arregloRegistros[$esteCuando]['totalVistas']+1;
	$arregloRegistros[$esteCuando][$idExperto]['vistas']=$arregloRegistros[$esteCuando][$idExperto]['vistas']+1;
...
//grafi
	...
	foreach ( $period as $dt ) {
	  ...
	  if($registros==""){$registros=0;}
		...
		$visitas=$arregloRegistros[$esteDia]['totalVistas']; if($visitas<1){$visitas=0;}
		
		$esteA=array();
		$esteA['date']=$esteDia;
		$esteA['category']="expertos";
